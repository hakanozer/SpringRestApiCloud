...
<header class="main-header">
    <!-- Logo -->
    <a href="<s:url value="/admin/dashboard"></s:url>" class="logo">
      <!-- mini logo for sidebar mini 50x50 pixels -->
      <span class="logo-mini"><b>A</b>LT</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Wissen</b>JAVA20</span>
    </a>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src='<s:url value="/resources/dist/img/user2-160x160.jpg"></s:url>' class="user-image" alt="User Image">
              <span class="hidden-xs">${ adm.getAname() } ${ adm.getAsurname() }</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
