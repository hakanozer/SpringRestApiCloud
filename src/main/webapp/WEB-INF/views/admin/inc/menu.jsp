...
<<<<<<< HEAD
             <li <c:if test="${ sayfa == 'users' }"> class="active" </c:if>><a href='<s:url value="/admin/users"></s:url>'><i class="fa fa-circle-o"></i>Users</a></li>
=======
<<<<<<< HEAD
             <li <c:if test="${ sayfa == 'product' }"> class="active" </c:if>><a href='<s:url value="/admin/product"></s:url>'><i class="fa fa-circle-o"></i>Product</a></li>
=======
            ...
            <li <c:if test="${ sayfa == 'orderManagement' }"> class="active" </c:if>><a href='<s:url value="/admin/orderManagement"></s:url>'><i class="fa fa-circle-o"></i>orderManagement</a></li>
>>>>>>> master
