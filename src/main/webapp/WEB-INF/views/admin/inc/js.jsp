...
<!-- InputMask -->
<script src="<s:url value="/resources/plugins/input-mask/jquery.inputmask.js"></s:url>"></script>
<script src="<s:url value="/resources/plugins/input-mask/jquery.inputmask.date.extensions.js"></s:url>"></script>
<script src="<s:url value="/resources/plugins/input-mask/jquery.inputmask.extensions.js"></s:url>"></script>
